...
$('div.makes-container').waypoint(function(direcao) {
    if (direcao == 'down') {
        $('div.makes-container').addClass('animate__animated animate__fadeInLeft animate__slow');
    } else {
        $('div.makes-container').removeClass('animate__animated animate__fadeInLeft animate__slow');
    }
}, { 
    offset: '65%' 
});